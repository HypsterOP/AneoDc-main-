...
module.exports = {
  ...
  run: async (client, message, args) => {
    if (args[0] === "diamond") {
      let diaaa = new Discord.MessageEmbed()
        .setTitle(`Diamond`)
        .setThumbnail(
        ...
        .setColor("RANDOM");
      message.channel.send({ embeds: [diaaa] });
      ...
      let car = new Discord.MessageEmbed()
        .setTitle(`Car`)
        .setThumbnail(
          "https://cdn.discordapp.com/attachments/838741259212423178/848177116154429461/car-emoji-by-twitter.png"
        )
        .setDescription(
          `Wohohooooooooo! Go drive a car once a day and earn upto 10,000 coins!`
        )
        .addField(`🤑 Selling Price`, `3,000`)
        .addField(`💲 Item Price`, `5,000`)
        .setColor("RANDOM");
      message.channel.send({ embeds: [car] });
    } else if (args[0] === "mansion") {
      let mantion = new Discord.MessageEmbed()
        .setTitle(`Mansion`)
        .setThumbnail(
          "https://cdn.discordapp.com/attachments/838741259212423178/848178106225131520/house-apple.png"
        )
        .setDescription(
          `Buy a mansion and collect rent from tenants once a week!, you can earn upto 30000 coins!`
        )
        .addField(`🤑 Selling Price`, `10,000`)
        .addField(`💲 Item Price`, `20,000`)
        .setColor("RANDOM");
      message.channel.send({ embeds: [mantion] });
    } else if (args[0] === "minecraft") {
      let mc = new Discord.MessageEmbed()
        .setTitle(`Minecraft`)
        .setThumbnail(
          "https://cdn.discordapp.com/attachments/838741259212423178/848178872460771348/png-clipart-minecraft-video-game-mod-emoji-minecraft-grass-video-game.png"
        )
