    ...
    run: async(client, message, args) => {
     ...
     .setColor("RED")
      ...
      allowedMentions: { repliedUser: false }
           ...
           let crimes = ["You beat up an old lady and manage to steal","You steal a car and then sold it for","You go into Mr beast's house and steal","You didn't manage to do anything, but I give you a gift of","You are a genius, and managed to quickly grab someone's purse and run away. In it you found", "You ransacked your manager's home, found his prized alarm clock, and sold it for", `You sell a truckload of stolen goods and the former president's suit for `]
