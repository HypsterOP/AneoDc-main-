...
module.exports = {
    ...
    try {
      ...
      if (!args[0]) {
        const embed = new MessageEmbed()
          ...
          .setDescription(
            "To use these commands, `" + p + "welcome <command>`"
          )
          .addField(
            "Commands Plugins",
        ...
        if (!URL) {
          let em = new MessageEmbed()
            ...
            .addField(
              "Reason",
              "Image requires at least One (1) argument. `" +
                p +
                "welcome image [url]`"
            )
            .setTimestamp();
        ...
        if (welback == null) {
          return msg.channel.send({embeds: [
            new MessageEmbed()
              .setColor("RED")
              .setTitle("❌  You Have Not Enable Welcome Image")
  ...
  chan
    ...
    : "No Welcome Channel Is Set, `" +
                    p +
                    "welcome channel` To Set One"
}\n${
  welmsg
    ? "<:ayumuTick:842630449200889856>"
    : "<:no:860411707242840064>"
  ...
  welc
    ...
    : "No Welcome Text Is Set, `" +
                    p +
                    "welcome color welcome` To Set One"
}\n${
  user
    ? "<:ayumuTick:842630449200889856>"
    : "<:no:860411707242840064>"
  ...
  en
    ? "Welcome Embed Is Set"
    : "Welcome Embed Is Not Enabled, `" +
                    p +
                    "welcome embed` To Set One."
}`
            )
            .setTimestamp();
          msg.channel.send({embeds: [emb]});
        ...
        if (msg1 == null) {
          return msg.channel.send({embeds: [
            new MessageEmbed()
              .setColor("RED")
              .setTitle("❌ You Have Not Enabled Welcome Message")
        ...
        if (!args[1]) {
          const emb = new MessageEmbed()
            ...
            .addField(
              ...
              "```Change The Welcome Text Color, Ex. " +
                p +
                "welcome color welcome #00FF00```"
            )
            .addField(
              p + "welcome color user",
              "```Change The Username Text Color, Ex. " +
                p +
                "welcome color user #00FF00```"
            )
            .setTimestamp();
          return msg.channel.send({embeds: [emb]});
          ...
          if (!color) {
            const h = new MessageEmbed()
              ...
              .setTimestamp();
            return msg.channel.send({embeds: [h]});
          } else {
        ...
        if (!args[1]) {
          const emb = new MessageEmbed()
            ...
            .addField(
              ...
              "```Removes The Welcome Text Color, Ex. " +
                p +
                "welcome colorremove welcome```"
            )
            .addField(
              p + "welcome colorremove user",
              "```Removes The Username Text Color, Ex. " +
                p +
                "welcome colorremove user```"
            )
            .setTimestamp();
          return msg.channel.send({embeds: [emb]});
        } else if (args[1].toLowerCase() === "welcome") {
