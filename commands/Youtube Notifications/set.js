...
module.exports = {
    ...
    run: async(client, message, args) => {
        ...
        if(!message.member.hasPermission("ADMINISTRATOR")) return message.reply(client.error +" You cannot use this command!")
        ...
        if(!ChannelLink || !DiscordChannel || !DiscordUser) return message.reply(`:x: Usage: \`${prefix}set <Link> <Discord Channel> <User> [Text...]\`\n\n**Replacements:**\n` + toreplace_format)
