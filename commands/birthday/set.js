  ...
  run: async (client, message, args) => {
    ...
    if (!day)
      return message.reply({
        content: "Please specify a date! Ex- *set 6/11",
    ...
    if (isNaN(day) || isNaN(month))
      return message.reply({
        content: "Please specify a valid number! Ex- *set 5/12",
        allowedMentions: { repliedUser: true },
      });
    ...
    if (!day || day > 31)
      return message.reply({
        content: "Please specify a date within 31! Ex- *set 5/12",
        allowedMentions: { repliedUser: true },
      });
    if (!month || month > 12)
      return message.reply({
    ...
    message.reply({
      content: `${BirthdayString} has been set as your bithday Date!`,
      allowedMentions: { repliedUser: true },
    });
  },
};
